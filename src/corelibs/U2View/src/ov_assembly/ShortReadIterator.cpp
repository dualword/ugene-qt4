...
void ShortReadIterator::skipPaddingAndHardClip() {
...
namespace {
void check(const QByteArray & expectedSeq, ShortReadIterator & it) {
    int i = 0;
    while(it.hasNext()) {
...
void t01() {
    ...
    ShortReadIterator it(read, cigar);
